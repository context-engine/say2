...
describe("Task-Augmented Execution Integration", () => {
    ...
    describe("getToolTaskSupport", () => {
        ...
        test("returns 'optional' for tool with taskSupport: optional", async () => {
            ...
            const support = clientManager.getToolTaskSupport(sessionId, "longProcess");
        ...
        test("returns 'required' for tool with taskSupport: required", async () => {
            ...
            const support = clientManager.getToolTaskSupport(sessionId, "backgroundJob");
        ...
        test("returns 'forbidden' for unknown tool", async () => {
            ...
            const support = clientManager.getToolTaskSupport(sessionId, "nonexistent");
            expect(support).toBe("forbidden");
        });
    });
    ...
    describe("getTask", () => {
        test("retrieves task status by ID", async () => {
            ...
            const task = await clientManager.getTask(sessionId, createResult.task.taskId);
    ...
    describe("callToolAsTaskAndWait", () => {
        test("polls until task completes and returns result", async () => {
            ...
            const result = await clientManager.callToolAsTaskAndWait(
                sessionId,
        ...
        test("throws error when task fails", async () => {
            ...
            await expect(
                clientManager.callToolAsTaskAndWait(
                    sessionId,
                    { name: "failingTask", arguments: {} },
                ),
            ).rejects.toThrow();
        });
    });
